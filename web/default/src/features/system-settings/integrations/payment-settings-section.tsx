              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-4 pt-2'>
                  <div>
                    ...
                    <p className='text-muted-foreground text-sm'>
                      {t(
                        'Configuration for official Alipay face-to-face payment'
                      )}
                    </p>
                  </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            {t(
                              'Official Alipay open platform application APPID'
                            )}
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            {t(
                              'Use sandbox gateway only for Alipay sandbox testing'
                            )}
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
