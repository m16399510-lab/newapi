  ...
  useEffect(() => {
    ...
    if (editData) {
      form.reset({
        ...
        dailyRequestLimit: editData.dailyRequestLimit || '',
      })
      setPricingMode(
            ...
            <div className='grid items-start gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(220px,260px)]'>
              <FieldGroup>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('Daily global request limit')}</FormLabel>
                      <FormControl>
                        <Input
                          type='number'
                          min={0}
                      ...
                      <FormDescription>
                        {t(
                          'Shared by Guangzhou, Hong Kong, all users, tokens, and groups. Set 0 for unlimited.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
