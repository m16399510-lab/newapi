...
const AuthenticatedEmptyResponseCompensationIndexRoute =
  AuthenticatedEmptyResponseCompensationIndexRouteImport.update({
    id: '/empty-response-compensation/',
    path: '/empty-response-compensation/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/empty-response-compensation/': {
      id: '/_authenticated/empty-response-compensation/'
      path: '/empty-response-compensation'
      fullPath: '/empty-response-compensation/'
      preLoaderRoute: typeof AuthenticatedEmptyResponseCompensationIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/dashboard/': {
